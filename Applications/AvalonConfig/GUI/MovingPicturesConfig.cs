    ...
    public class MovingPicturesConfig : GUIWindow
    {
       ...
       protected GUIButtonControl btnThumbViewMod = null;
        ...
        private void ApplyConfigurationChanges()
        {
            ...
            AvalonHelper.SetSkinImport(skinFile, "Background", string.Format("movingpictures.background.{0}.xml", style));
            AvalonHelper.SetSkinImport(skinFile, "Views", string.Format("movingpictures.views.{0}.xml", style));
            AvalonHelper.SetSkinImport(skinFile, "Facade", string.Format("movingpictures.facade.{0}.xml", style));
            AvalonHelper.SetSkinImport(skinFile, "Mediainfo", string.Format("movingpictures.mediainfo.{0}.xml", style));
            //Log.Info(skinFile);
            ...
            switch (ThumbViewMod)
            {
                ...
                case Views.ThumbsNoFanart:
                    AvalonHelper.SetSkinImport(skinFile, "Background", string.Format("movingpictures.background.{0}.thumbs.nofanart.xml", style));
                    AvalonHelper.SetSkinImport(skinFile, "Facade", string.Format("movingpictures.facade.{0}.thumbs.nofanart.xml", style));
                    break;

                case Views.ThumbsXL:
                    AvalonHelper.SetSkinImport(skinFile, "Background", string.Format("movingpictures.background.{0}.thumbs.XL.xml", style));
                    AvalonHelper.SetSkinImport(skinFile, "Facade", string.Format("movingpictures.facade.{0}.thumbs.XL.xml", style));
                    break;
            }
        ...
        public override int GetID
        {
            get
            {
                return (int)AvalonGUIConfig.AvalonScreenID.AvalonMovPicsConfig;
            }
        }

        public override bool Init()
        {
            return Load(GUIGraphicsContext.Skin + @"\AvalonConfig_movingpictures.xml");
        }
